...
- Unit evidence: provider adapter and credential-vault tests pass. Full verification and live browser evidence are recorded after the rebuilt Compose stack is exercised.
