...
export default async function PartialProcessingPage() {
  return (
    <CallStateView
      title="Partial processing"
      description="Calls whose enrichment did not finish. The transcript is authoritative; the summary, classification or outcome may be missing."
