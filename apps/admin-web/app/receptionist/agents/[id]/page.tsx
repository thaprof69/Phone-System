...
export default async function AgentDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!agentsResponse.ok) {
    return (
      <AppShell>
        <Breadcrumbs
          trail={[{ label: 'Agents', href: '/receptionist/agents' }, { label: 'Agent' }]}
        />
  ...
  return (
    <AppShell>
      <Breadcrumbs
        trail={[{ label: 'Agents', href: '/receptionist/agents' }, { label: agent.name }]}
      />
      <PageHeading
        ...
        actions={
          <Link className="button secondary" href="/receptionist/releases">
            Release pipeline
          </Link>
        }
      />
          ...
          },
          {
            ...
            content: (
              <Panel
                ...
                action={
                  <Link className="button ghost small" href="/receptionist/voices">
                    Voice library
                  </Link>
                }
              >
          ...
          },
          {
            ...
            content: (
              <Panel
                ...
                action={
                  <Link className="button ghost small" href="/quality/runs">
                    All runs
                  </Link>
                }
              >
