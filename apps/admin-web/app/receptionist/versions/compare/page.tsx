...
export default async function CompareVersionsPage({
  ...
  return (
    <AppShell>
      <Breadcrumbs
        trail={[{ label: 'Versions', href: '/receptionist/versions' }, { label: 'Compare' }]}
      />
      <PageHeading
        ...
        actions={
          <Link className="button secondary" href="/receptionist/versions">
            All versions
          </Link>
        }
      />

      <form className="filter-bar" method="get" action="/receptionist/versions/compare">
