...
export default async function KnowledgeLibraryPage({
  ...
  return (
    ...
    >
      ...
      <FilterBar
        action="/settings/knowledge/library"
        resetHref="/settings/knowledge/library"
      ...
      >
        <DataTable
          ...
          buildSortHref={(key, direction) =>
            buildHref('/settings/knowledge/library', params, {
              sort: key,
              dir: direction,
              page: undefined,
            })
        ...
        <Pagination
          ...
          total={sorted.length}
          buildHref={(next) => buildHref('/settings/knowledge/library', params, { page: next })}
        />
      </Panel>
    </DomainPage>
  );
